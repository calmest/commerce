            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <input type="text" class="form-control" id="product_name" name="product_name" value="{{ $productDetails->product_name }}" placeholder="Category Name">
                        <span id="chkPwd"></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <input type="text" class="form-control" id="url" name="url" value="{{ $productDetails->url }}" placeholder="URL">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="description" class="col-lg-3 col-md-3 col-sm-3 control-label col-form-label">Description</label>
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <textarea type="text" class="form-control" id="description" name="description" placeholder="Description" rows="5">{{ $productDetails->description }}</textarea>
                    </div>
                </div>
            </div>
