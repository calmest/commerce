...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        @endif
        <form class="form-horizontal" method="POST" action="{{ url('/user/edit-image/'.$imageDetails->id) }}" novalidate="novalidate" id="add_category" name="add_category" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
