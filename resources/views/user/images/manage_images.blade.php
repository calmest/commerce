...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">View Images</h4>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('/user/edit-image/'.$item->id) }}" class="btn btn-cyan btn-sm">Edit</a>
                                                    <br>
                                                    <a id="delCat" href="{{ url('/user/delete-image/'.$item->id) }}" class="btn btn-danger btn-sm">Delete</a>
