                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('/user/edit-video/'.$item->id) }}" class="btn btn-cyan btn-sm">Edit</a>
                                                    <br>
                                                    <a id="delCat" href="{{ url('/user/delete-video/'.$item->id) }}" class="btn btn-danger btn-sm">Delete</a>
