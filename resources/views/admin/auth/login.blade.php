        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" role="form" method="POST" action="{{ url('/admin/login') }}">
                        {{ csrf_field() }}
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <button class="btn btn-info" type="button"><i class="fa fa-lock m-r-5"></i><a href="/admin/register" style="color: #fff;">Register</a></button>
