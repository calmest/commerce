...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        @endif
        <form class="form-horizontal" method="POST" action="{{ url('/admin/edit-video/'.$videoDetails->id) }}" novalidate="novalidate" id="add_category" name="add_category" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
